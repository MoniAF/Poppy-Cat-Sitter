 ...
 */
public class PanelJuegoGS extends javax.swing.JPanel {

    private ControladorG controlador;
    /**
     * Creates new form PanelJuegoGS
     */
    public PanelJuegoGS() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        amarilloOff.setIcon(new javax.swing.ImageIcon(getClass().getResource("/img/Gris off sleep.png"))); // NOI18N
